...
class _$HomeStateImpl implements _HomeState {
  const _$HomeStateImpl({required this.totalDist});
  ...
  @override
  String toString() {
    return 'HomeState(totalDist: $totalDist)';
  }
  ...
  @override
  int get hashCode => Object.hash(runtimeType, totalDist);
...
abstract class _HomeState implements HomeState {
  const factory _HomeState({required final double totalDist}) = _$HomeStateImpl;
